...
export const YoutubeIcon = ({fill = "currentColor", size = 25, height = 25, width = 25, ...props}) => {
  return (
    <svg
      fill="none"
...
export const DeezerIcon = ({fill = "currentColor", size = 25, height = 25, width = 25, ...props}) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
...
export const SpotifyIcon = ({fill = "currentColor", size = 25, height = 25, width = 25, ...props}) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
...
export const AppleIcon = ({fill = "currentColor", size = 25, height = 25, width = 25, ...props}) => {
  return (
    <svg
      fill="none"
      height={size || height || 24}
